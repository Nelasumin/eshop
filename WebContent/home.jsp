			...
			<div class="carousel slide" id="carousel-210314" data-ride="carousel" data-interval="2000">
				...
				<div class="carousel-inner">
					<div class="item active">
						...
						<div class="carousel-caption" onclick="alert('轮播图随意购商城未开放')">
							<h4 >
								随意购商城
							</h4>
							<p>
					...
					<div class="item">
						...
						<div class="carousel-caption"  onclick="alert('轮播图美丽女人频道未开放')">
							<h4>
								美丽女人
							</h4>
							<p>
					...
					<div class="item">
						...
						<div class="carousel-caption"  onclick="alert('轮播图满减活动未开放')">
							<h4>
								满减活动
							</h4>
							<p>
					...
					<div class="col-md-2 column ">	
					    ...
					    <div class="thumbnail todaygoods" id="">
					     ...
					     <div class="caption text-center">
					        <h4 class="font-red">￥${c.goods_discount}</h4>
					        <p>${c.goods_name}</p>
					      </div>
					    </div>
					    </a>				
