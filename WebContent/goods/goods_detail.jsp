	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<div class="panel panel-default">
			  <div class="panel-body bg_goodsdetail">
			    <p>促销价：<span class="price_red "><small>￥</small>${goodsDetail.goodsDiscount}</span></p>
			    <p>原价：<span class="price"><small>￥</small>${goodsDetail.goodsPrice}</span></p>
	    ...
	    <form id="fm_goods" class="form-inline" role="form"  method="post">	
			    ...
			    <input type="hidden" name="goodsPostalfee" value="${goodsDetail.goodsPostalfee}"/>	
			       <input type="hidden" name="goodsPic" value="${goodsDetail.goodsPic}"/>		
			...
			<div class="row row_style">
		     ...
		     <div class="row row_style">
		        <div class="col-md-12">
					...
					<p>
<%-- 						<a href="${pageContext.request.contextPath}/goods/payGoods.jsp"> --%>
						<a href="${pageContext.request.contextPath}/goods/payGoods.jsp">
