...
<div class="row"  style="border:0px solid red">
  ...
  <div class="col-md-10"> 
	...
	<c:forEach items="${goods}" var="g">
		<div class="col-md-4" >
			<div class="thumbnail">
				...
				<img width="148px" heigth="112px" alt="${g.goodsName}" src="${pageContext.request.contextPath}${g.goodsPic}" />
				</div>
	...
	<c:if test="${empty goods}">
		<div class="alert alert-danger col-md-2" role="alert">对不起，暂无商品</div>
	</c:if>	
